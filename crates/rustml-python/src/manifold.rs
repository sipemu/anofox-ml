...
use rustml_core::FitUnsupervised;
...
#[pyclass]
pub struct TSne {
    inner: rustml_manifold::TSne,
    fitted: Option<rustml_manifold::FittedTSne>,
}
...
impl TSne {
    ...
    fn new(
        ...
        let m = match method {
            "exact" => rustml_manifold::TSneMethod::Exact,
            "barnes_hut" => rustml_manifold::TSneMethod::BarnesHut,
            other => {
        ...
        Ok(Self {
            inner: rustml_manifold::TSne::new(n_components)
...
#[pyclass]
pub struct Isomap {
    inner: rustml_manifold::Isomap,
    fitted: Option<rustml_manifold::FittedIsomap>,
}
...
impl Isomap {
    ...
    fn new(n_components: usize, n_neighbors: usize) -> Self {
        Self {
            inner: rustml_manifold::Isomap::new(n_components, n_neighbors),
            fitted: None,
        }
    }
    fn fit_transform<'py>(
...
pub struct LocallyLinearEmbedding {
    inner: rustml_manifold::LocallyLinearEmbedding,
    fitted: Option<rustml_manifold::FittedLocallyLinearEmbedding>,
}
...
impl LocallyLinearEmbedding {
    ...
    fn new(n_components: usize, n_neighbors: usize) -> Self {
        Self {
            inner: rustml_manifold::LocallyLinearEmbedding::new(n_components, n_neighbors),
            fitted: None,
        }
    }
    fn fit_transform<'py>(
