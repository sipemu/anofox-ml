...
use rustml_core::{Fit, FitUnsupervised, InverseTransform, Transform};
...
pub struct MinMaxScaler {
    inner: rustml_preprocessing::MinMaxScaler<f64>,
    fitted: Option<rustml_preprocessing::FittedMinMaxScaler<f64>>,
}
...
impl MinMaxScaler {
    ...
    fn new(feature_min: f64, feature_max: f64) -> Self {
        Self {
            inner: rustml_preprocessing::MinMaxScaler::new().with_range(feature_min, feature_max),
            fitted: None,
        }
    }
...
#[pyclass]
pub struct Pca {
    inner: rustml_preprocessing::Pca,
    fitted: Option<rustml_preprocessing::FittedPca<f64>>,
}
...
impl Pca {
    ...
    fn new(n_components: usize) -> Self {
        Self {
            inner: rustml_preprocessing::Pca::new(n_components),
            fitted: None,
        }
    }
