...
pub struct MlpClassifier {
    inner: rustml_neural_networks::MlpClassifier,
    fitted: Option<rustml_neural_networks::FittedMlpClassifier<f64>>,
}
...
pub struct MlpRegressor {
    inner: rustml_neural_networks::MlpRegressor,
    fitted: Option<rustml_neural_networks::FittedMlpRegressor<f64>>,
}
