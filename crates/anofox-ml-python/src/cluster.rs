...
use anofox_ml_core::{FitUnsupervised, Predict, PredictProba};
...
#[pyclass]
pub struct KMeans {
    inner: anofox_ml_cluster::KMeans,
    fitted: Option<anofox_ml_cluster::FittedKMeans<f64>>,
}
...
impl KMeans {
    ...
    fn new(n_clusters: usize, max_iter: usize, seed: u64) -> Self {
        Self {
            inner: anofox_ml_cluster::KMeans::new(n_clusters)
    ...
    fn load_json(path: &str) -> PyResult<Self> {
        ...
        Ok(Self {
            inner: anofox_ml_cluster::KMeans::new(3),
            fitted: Some(fitted),
        })
    }
...
#[pyclass]
pub struct Dbscan {
    inner: anofox_ml_cluster::Dbscan,
    fitted: Option<anofox_ml_cluster::FittedDbscan<f64>>,
}
...
impl Dbscan {
    ...
    fn new(eps: f64, min_samples: usize) -> Self {
        Self {
            inner: anofox_ml_cluster::Dbscan::new(eps, min_samples),
            fitted: None,
        }
    }
    ...
    fn load_json(path: &str) -> PyResult<Self> {
        let fitted = anofox_ml_core::persistence::load_json(path).map_err(py_err)?;
        Ok(Self {
            inner: anofox_ml_cluster::Dbscan::new(0.5, 5),
            fitted: Some(fitted),
        })
    }
...
#[pyclass]
pub struct Hdbscan {
    inner: anofox_ml_cluster::Hdbscan,
    fitted: Option<anofox_ml_cluster::FittedHdbscan>,
}
...
impl Hdbscan {
    ...
    fn new(min_samples: usize, min_cluster_size: usize) -> Self {
        Self {
            inner: anofox_ml_cluster::Hdbscan::new(min_samples, min_cluster_size),
            fitted: None,
        }
    }
    fn fit<'py>(&mut self, x: PyReadonlyArray2<'py, f64>) -> PyResult<()> {
...
pub struct MeanShift {
    inner: anofox_ml_cluster::MeanShift,
    fitted: Option<anofox_ml_cluster::FittedMeanShift>,
}
...
impl MeanShift {
    ...
    fn new(bandwidth: f64) -> Self {
        Self {
            inner: anofox_ml_cluster::MeanShift::new(bandwidth),
            fitted: None,
        }
    }
    fn fit<'py>(&mut self, x: PyReadonlyArray2<'py, f64>) -> PyResult<()> {
...
pub struct AffinityPropagation {
    inner: anofox_ml_cluster::AffinityPropagation,
    fitted: Option<anofox_ml_cluster::FittedAffinityPropagation>,
}
...
impl AffinityPropagation {
    ...
    fn new(damping: f64, preference: Option<f64>, n_neighbors: Option<usize>) -> Self {
        let mut ap = anofox_ml_cluster::AffinityPropagation::new().with_damping(damping);
...
pub struct BayesianGaussianMixture {
    inner: anofox_ml_cluster::BayesianGaussianMixture,
    fitted: Option<anofox_ml_cluster::FittedBayesianGaussianMixture>,
}
...
impl BayesianGaussianMixture {
    ...
    fn new(
        ...
        Self {
            inner: anofox_ml_cluster::BayesianGaussianMixture::new(n_components)
