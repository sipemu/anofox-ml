...
pub struct DecisionTreeClassifier {
    inner: anofox_ml_trees::DecisionTreeClassifier,
    fitted: Option<anofox_ml_trees::FittedDecisionTreeClassifier<f64>>,
}
...
impl DecisionTreeClassifier {
    ...
    fn new(max_depth: Option<usize>, min_samples_split: usize, min_samples_leaf: usize) -> Self {
        Self {
            inner: anofox_ml_trees::DecisionTreeClassifier::new()
...
pub struct DecisionTreeRegressor {
    inner: anofox_ml_trees::DecisionTreeRegressor,
    fitted: Option<anofox_ml_trees::FittedDecisionTreeRegressor<f64>>,
}
...
impl DecisionTreeRegressor {
    ...
    fn new(max_depth: Option<usize>, min_samples_split: usize, min_samples_leaf: usize) -> Self {
        Self {
            inner: anofox_ml_trees::DecisionTreeRegressor::new()
                .with_max_depth(max_depth)
                .with_min_samples_split(min_samples_split)
                .with_min_samples_leaf(min_samples_leaf),
            fitted: None,
