...
pub struct LinearSvc {
    inner: anofox_ml_svm::LinearSvc,
    fitted: Option<anofox_ml_svm::FittedLinearSvc<f64>>,
}
...
impl LinearSvc {
    ...
    fn new(c: f64, max_iter: usize, tol: f64, seed: u64) -> Self {
        Self {
            inner: anofox_ml_svm::LinearSvc::new()
                .with_c(c)
...
#[pyclass]
pub struct Svc {
    inner: anofox_ml_svm::Svc,
    fitted: Option<anofox_ml_svm::FittedSvc<f64>>,
}
